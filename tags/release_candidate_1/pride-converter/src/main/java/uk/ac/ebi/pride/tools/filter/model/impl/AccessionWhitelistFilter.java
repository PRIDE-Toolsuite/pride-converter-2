 ...
 * Time: 16:29
 */
public class AccessionWhitelistFilter extends AbstractListFilter {

    public AccessionWhitelistFilter(Set<String> accessionsToFilter) {
        super(accessionsToFilter);
    }

    public AccessionWhitelistFilter(String filePath) {
        super(filePath);
    }
