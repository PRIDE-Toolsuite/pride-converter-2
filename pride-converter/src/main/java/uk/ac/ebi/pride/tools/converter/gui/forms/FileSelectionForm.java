                                            ...
                                            .addGroup(singleFilePanelLayout.createSequentialGroup()
                                                    .addGroup(singleFilePanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                                            ...
                                                            .addGroup(singleFilePanelLayout.createSequentialGroup()
                                                                    ...
                                                                    .addGap(18, 18, 18)))
                                                    .addGroup(singleFilePanelLayout.createParallelGroup()
                                                            .addComponent(singleMzTabFile, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
                                                            .addComponent(singleSpectrumFile, GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
                                                            .addGroup(singleFilePanelLayout.createSequentialGroup()
                                                                    .addComponent(singleFastaFile, GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addComponent(fastaFormatList, 0, 123, Short.MAX_VALUE))
                                                            .addGroup(singleFilePanelLayout.createSequentialGroup()
                                                                    .addComponent(singleSourceFile, GroupLayout.DEFAULT_SIZE, 439, Short.MAX_VALUE)
                                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
            ...
            parserOptionPanelLayout.setVerticalGroup(
                    parserOptionPanelLayout.createParallelGroup()
                            .addGroup(parserOptionPanelLayout.createSequentialGroup()
                                    .addComponent(showHideLabel)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(tableScrollPane, GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
