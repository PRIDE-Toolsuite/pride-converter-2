...
public abstract class AbstractDialog extends JDialog {
    ...
    public static AbstractDialog getInstance(BaseTable<? extends ReportObject> table, Class cls) {
        ...
        if (dialogClass != null) {
            try {
                ...
                //set editing mode - this impact the OK actionPerformed
                ad.isEditing = true;
                return ad;
            } catch (Exception e) {
    ...
    protected void saveTemplate(String templateName, TemplateType type, ReportObject templateObject) {
        ...
        //check to see if templateName exists
        ...
        if (!template.exists()) {
            ...
            int value = JOptionPane.showConfirmDialog(NavigationPanel.getInstance(),
                    "Template already exists. Click on OK to save and overwrite or CANCEL to abort",
                    "Warning",
